...
@section('content')
    ...
    <form method="post" id="edit_round" action="{{ route('rounds.update', $id) }}">
        ...
        <div class="form-holder">
            ...
            <h3 class="title"><span>Round Details</span></h3>
                ...
                <div class="row">
                    ...
                    <label>Course</label>
                    <h3>{{ $course->property_name }} - {{ $course->course_name }}</h3>
                ...
                <div class="col-12 col-md-8 offset-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <span class="switch switch-lg">
                            ...
                            <input type="checkbox" class="switch" id="stats_round" name="stats_round" value="1" @if($round->stats_round === 1) checked @endif>
                    ...
                    <div class="col-12 col-md-8 offset-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <span class="switch switch-lg">
                                    ...
                                    <input type="checkbox" class="switch" id="handicap_round" name="handicap_round" value="1" @if($round->handicap_round === 1) checked @endif>
            ...
            <h3 class="title"><span>Score Card</span></h3>
            ...
            <div class="row rr-row @if ($round->yards === 'white') white @elseif ($round->yards === 'yellow') yellow @elseif ($round->yards === 'red') red @endif">
            ...
            <div id="FirstNineFirs" class="row rr-row add-round-fir">
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <input id="hole_1_fir" type="checkbox" class="form-control FirstNineFir custom-control-input" name="hole_1_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_1_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_1_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_1_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_1_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <input id="hole_2_fir" type="checkbox" class="form-control FirstNineFir custom-control-input" name="hole_2_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_2_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_2_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_2_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_2_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <input id="hole_3_fir" type="checkbox" class="form-control FirstNineFir custom-control-input" name="hole_3_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_3_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_3_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_3_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_3_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <input id="hole_4_fir" type="checkbox" class="form-control FirstNineFir custom-control-input" name="hole_4_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_4_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_4_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_4_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_4_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <input id="hole_5_fir" type="checkbox" class="form-control FirstNineFir custom-control-input" name="hole_5_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_5_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_5_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_5_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_5_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <input id="hole_6_fir" type="checkbox" class="form-control FirstNineFir custom-control-input" name="hole_6_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_6_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_6_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_6_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_6_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <input id="hole_7_fir" type="checkbox" class="form-control FirstNineFir custom-control-input" name="hole_7_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_7_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_7_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_7_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_7_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <input id="hole_8_fir" type="checkbox" class="form-control FirstNineFir custom-control-input" name="hole_8_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_8_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_8_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_8_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_8_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <input id="hole_9_fir" type="checkbox" class="form-control FirstNineFir custom-control-input" name="hole_9_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_9_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_9_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_9_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_9_fir === 1)
                                    checked
                                    @endif
...
<div class="show-stats">
            ...
            <div id="SecondNineFirs" class="row rr-row add-round-fir">
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_10_fir" type="checkbox" class="form-control SecondNineFir custom-control-input" name="hole_10_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_10_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_10_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_10_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_10_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_11_fir" type="checkbox" class="form-control SecondNineFir custom-control-input" name="hole_11_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_11_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_11_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_11_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_11_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_12_fir" type="checkbox" class="form-control SecondNineFir custom-control-input" name="hole_12_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_12_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_12_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_12_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_12_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_13_fir" type="checkbox" class="form-control SecondNineFir custom-control-input" name="hole_13_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_13_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_13_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_13_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_13_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_14_fir" type="checkbox" class="form-control SecondNineFir custom-control-input" name="hole_14_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_14_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_14_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_14_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_14_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_15_fir" type="checkbox" class="form-control SecondNineFir custom-control-input" name="hole_15_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_15_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_15_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_15_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_15_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_16_fir" type="checkbox" class="form-control SecondNineFir custom-control-input" name="hole_16_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_16_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_16_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_16_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_16_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_17_fir" type="checkbox" class="form-control SecondNineFir custom-control-input" name="hole_17_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_17_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_17_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_17_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_17_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_18_fir" type="checkbox" class="form-control SecondNineFir custom-control-input" name="hole_18_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_18_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_18_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_18_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_18_fir === 1)
                                    checked
                                    @endif
            ...
            <h4 class="text-center">{{ $course->third_nine_name }}</h4>
            ...
            <div class="row rr-row add-round-yards @if ($round->yards === 'white') white @elseif ($round->yards === 'yellow') yellow @elseif ($round->yards === 'red') red @endif">
...
<div class="show-stats">
            ...
            <div id="ThirdNineFirs" class="row rr-row add-round-fir">
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_19_fir" type="checkbox" class="form-control ThirdNineFir custom-control-input" name="hole_19_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_19_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_19_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_19_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_19_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_20_fir" type="checkbox" class="form-control ThirdNineFir custom-control-input" name="hole_20_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_20_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_20_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_20_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_20_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_21_fir" type="checkbox" class="form-control ThirdNineFir custom-control-input" name="hole_21_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_21_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_21_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_21_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_21_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_22_fir" type="checkbox" class="form-control ThirdNineFir custom-control-input" name="hole_22_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_22_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_22_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_22_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_22_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_23_fir" type="checkbox" class="form-control ThirdNineFir custom-control-input" name="hole_23_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_23_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_23_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_23_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_23_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_24_fir" type="checkbox" class="form-control ThirdNineFir custom-control-input" name="hole_24_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_24_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_24_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_24_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_24_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_25_fir" type="checkbox" class="form-control ThirdNineFir custom-control-input" name="hole_25_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_25_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_25_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_25_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_25_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_26_fir" type="checkbox" class="form-control ThirdNineFir custom-control-input" name="hole_26_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_26_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_26_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_26_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_26_fir === 1)
                                    checked
                                    @endif
                ...
                <div class="col rr-cell">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input id="hole_27_fir" type="checkbox" class="form-control ThirdNineFir custom-control-input" name="hole_27_fir" value="1" @if ($round->yards === 'white')
                        {{ ($course->hole_27_white_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'yellow')
                            {{ ($course->hole_27_yellow_par < 4 ? "disabled" :"") }} @elseif ($round->yards === 'red')
                                {{ ($course->hole_27_red_par < 4 ? "disabled" :"") }} @endif @if($round->hole_27_fir === 1)
                                    checked
                                    @endif
