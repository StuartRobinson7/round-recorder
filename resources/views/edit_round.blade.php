                    ...
                    <form method="post" id="edit_round" action="{{ route('rounds.update', $id) }}">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_1_fir" type="checkbox" class="form-control" name="hole_1_fir" value="1" {{ ($course->hole_1_par < 4 ? "disabled":"") }}  @if( $round->hole_1_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_2_fir" type="checkbox" class="form-control" name="hole_2_fir" value="1" {{ ($course->hole_2_par < 4 ? "disabled":"") }}  @if( $round->hole_2_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_3_fir" type="checkbox" class="form-control" name="hole_3_fir" value="1" {{ ($course->hole_3_par < 4 ? "disabled":"") }}  @if( $round->hole_3_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_4_fir" type="checkbox" class="form-control" name="hole_4_fir" value="1" {{ ($course->hole_4_par < 4 ? "disabled":"") }}  @if( $round->hole_4_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_5_fir" type="checkbox" class="form-control" name="hole_5_fir" value="1" {{ ($course->hole_5_par < 4 ? "disabled":"") }}  @if( $round->hole_5_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_6_fir" type="checkbox" class="form-control" name="hole_6_fir" value="1" {{ ($course->hole_6_par < 4 ? "disabled":"") }}  @if( $round->hole_6_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_7_fir" type="checkbox" class="form-control" name="hole_7_fir" value="1" {{ ($course->hole_7_par < 4 ? "disabled":"") }}  @if( $round->hole_7_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_8_fir" type="checkbox" class="form-control" name="hole_8_fir" value="1" {{ ($course->hole_8_par < 4 ? "disabled":"") }}  @if( $round->hole_8_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_9_fir" type="checkbox" class="form-control" name="hole_9_fir" value="1" {{ ($course->hole_9_par < 4 ? "disabled":"") }}  @if( $round->hole_9_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_10_fir" type="checkbox" class="form-control" name="hole_10_fir" value="1" {{ ($course->hole_10_par < 4 ? "disabled":"") }}  @if( $round->hole_10_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_11_fir" type="checkbox" class="form-control" name="hole_11_fir" value="1" {{ ($course->hole_11_par < 4 ? "disabled":"") }}  @if( $round->hole_11_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_12_fir" type="checkbox" class="form-control" name="hole_12_fir" value="1" {{ ($course->hole_12_par < 4 ? "disabled":"") }}  @if( $round->hole_12_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_13_fir" type="checkbox" class="form-control" name="hole_13_fir" value="1" {{ ($course->hole_13_par < 4 ? "disabled":"") }}  @if( $round->hole_13_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_14_fir" type="checkbox" class="form-control" name="hole_14_fir" value="1" {{ ($course->hole_14_par < 4 ? "disabled":"") }}  @if( $round->hole_14_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_15_fir" type="checkbox" class="form-control" name="hole_15_fir" value="1" {{ ($course->hole_15_par < 4 ? "disabled":"") }}  @if( $round->hole_15_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_16_fir" type="checkbox" class="form-control" name="hole_16_fir" value="1" {{ ($course->hole_16_par < 4 ? "disabled":"") }}  @if( $round->hole_16_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_17_fir" type="checkbox" class="form-control" name="hole_17_fir" value="1" {{ ($course->hole_17_par < 4 ? "disabled":"") }}  @if( $round->hole_17_fir == 1) checked @endif></td>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_18_fir" type="checkbox" class="form-control" name="hole_18_fir" value="1" {{ ($course->hole_18_par < 4 ? "disabled":"") }} @if( $round->hole_18_fir == 1) checked @endif></td>
