                    ...
                    <form method="POST" action="{{ route('add_course') }}" aria-label="{{ __('Add Course') }}">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_1_stroke_index" type="text" class="form-control{{ $errors->has('hole_1_stroke_index') ? ' is-invalid' : '' }}" name="hole_1_stroke_index" value="{{ old('hole_1_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_1_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_1_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_1_ladies_stroke_index" value="{{ old('hole_1_ladies_stroke_index') }}"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_2_stroke_index" type="text" class="form-control{{ $errors->has('hole_2_stroke_index') ? ' is-invalid' : '' }}" name="hole_2_stroke_index" value="{{ old('hole_2_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_2_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_2_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_2_ladies_stroke_index" value="{{ old('hole_2_ladies_stroke_index') }}"></td>
                            </tr>                        
                            ...
                            <tr>
                                ...
                                <td><input id="hole_3_stroke_index" type="text" class="form-control{{ $errors->has('hole_3_stroke_index') ? ' is-invalid' : '' }}" name="hole_3_stroke_index" value="{{ old('hole_3_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_3_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_3_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_3_ladies_stroke_index" value="{{ old('hole_3_ladies_stroke_index') }}"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_4_stroke_index" type="text" class="form-control{{ $errors->has('hole_4_stroke_index') ? ' is-invalid' : '' }}" name="hole_4_stroke_index" value="{{ old('hole_4_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_4_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_4_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_4_ladies_stroke_index" value="{{ old('hole_4_ladies_stroke_index') }}"></td>
                            </tr>     
                            ...
                            <tr>
                                ...
                                <td><input id="hole_5_stroke_index" type="text" class="form-control{{ $errors->has('hole_5_stroke_index') ? ' is-invalid' : '' }}" name="hole_5_stroke_index" value="{{ old('hole_5_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_5_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_5_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_5_ladies_stroke_index" value="{{ old('hole_5_ladies_stroke_index') }}"></td>
                            </tr>                                           
                            ...
                            <tr>
                                ...
                                <td><input id="hole_6_stroke_index" type="text" class="form-control{{ $errors->has('hole_6_stroke_index') ? ' is-invalid' : '' }}" name="hole_6_stroke_index" value="{{ old('hole_6_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_6_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_6_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_6_ladies_stroke_index" value="{{ old('hole_6_ladies_stroke_index') }}"></td>
                            </tr>                        
                            ...
                            <tr>
                                ...
                                <td><input id="hole_7_stroke_index" type="text" class="form-control{{ $errors->has('hole_7_stroke_index') ? ' is-invalid' : '' }}" name="hole_7_stroke_index" value="{{ old('hole_7_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_7_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_7_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_7_ladies_stroke_index" value="{{ old('hole_7_ladies_stroke_index') }}"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_8_stroke_index" type="text" class="form-control{{ $errors->has('hole_8_stroke_index') ? ' is-invalid' : '' }}" name="hole_8_stroke_index" value="{{ old('hole_8_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_8_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_8_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_8_ladies_stroke_index" value="{{ old('hole_8_ladies_stroke_index') }}"></td>
                            </tr>     
                            ...
                            <tr>
                                ...
                                <td><input id="hole_9_stroke_index" type="text" class="form-control{{ $errors->has('hole_9_stroke_index') ? ' is-invalid' : '' }}" name="hole_9_stroke_index" value="{{ old('hole_9_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_9_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_9_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_9_ladies_stroke_index" value="{{ old('hole_9_ladies_stroke_index') }}"></td>
                            </tr>       
                            ...
                            <tr>
                                ...
                                <td><input id="hole_10_stroke_index" type="text" class="form-control{{ $errors->has('hole_10_stroke_index') ? ' is-invalid' : '' }}" name="hole_10_stroke_index" value="{{ old('hole_10_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_10_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_10_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_10_ladies_stroke_index" value="{{ old('hole_10_ladies_stroke_index') }}"></td>
                            </tr>      
                            ...
                            <tr>
                                ...
                                <td><input id="hole_11_stroke_index" type="text" class="form-control{{ $errors->has('hole_11_stroke_index') ? ' is-invalid' : '' }}" name="hole_11_stroke_index" value="{{ old('hole_11_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_11_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_11_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_11_ladies_stroke_index" value="{{ old('hole_11_ladies_stroke_index') }}"></td>
                            </tr>                                                                              
                            ...
                            <tr>
                                ...
                                <td><input id="hole_12_stroke_index" type="text" class="form-control{{ $errors->has('hole_12_stroke_index') ? ' is-invalid' : '' }}" name="hole_12_stroke_index" value="{{ old('hole_12_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_12_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_12_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_12_ladies_stroke_index" value="{{ old('hole_12_ladies_stroke_index') }}"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input id="hole_13_stroke_index" type="text" class="form-control{{ $errors->has('hole_13_stroke_index') ? ' is-invalid' : '' }}" name="hole_13_stroke_index" value="{{ old('hole_13_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_13_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_13_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_13_ladies_stroke_index" value="{{ old('hole_13_ladies_stroke_index') }}"></td>
                            </tr>         
                            ...
                            <tr>
                                ...
                                <td><input id="hole_14_stroke_index" type="text" class="form-control{{ $errors->has('hole_14_stroke_index') ? ' is-invalid' : '' }}" name="hole_14_stroke_index" value="{{ old('hole_14_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_14_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_14_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_14_ladies_stroke_index" value="{{ old('hole_14_ladies_stroke_index') }}"></td>
                            </tr>             
                            ...
                            <tr>
                                ...
                                <td><input id="hole_15_stroke_index" type="text" class="form-control{{ $errors->has('hole_15_stroke_index') ? ' is-invalid' : '' }}" name="hole_15_stroke_index" value="{{ old('hole_15_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_15_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_15_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_15_ladies_stroke_index" value="{{ old('hole_15_ladies_stroke_index') }}"></td>
                            </tr>     
                            ...
                            <tr>
                                ...
                                <td><input id="hole_16_stroke_index" type="text" class="form-control{{ $errors->has('hole_16_stroke_index') ? ' is-invalid' : '' }}" name="hole_16_stroke_index" value="{{ old('hole_16_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_16_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_16_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_16_ladies_stroke_index" value="{{ old('hole_16_ladies_stroke_index') }}"></td>
                            </tr>        
                            ...
                            <tr>
                                ...
                                <td><input id="hole_17_stroke_index" type="text" class="form-control{{ $errors->has('hole_17_stroke_index') ? ' is-invalid' : '' }}" name="hole_17_stroke_index" value="{{ old('hole_17_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_17_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_17_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_17_ladies_stroke_index" value="{{ old('hole_17_ladies_stroke_index') }}"></td>
                            </tr>        
                            ...
                            <tr>
                                ...
                                <td><input id="hole_18_stroke_index" type="text" class="form-control{{ $errors->has('hole_18_stroke_index') ? ' is-invalid' : '' }}" name="hole_18_stroke_index" value="{{ old('hole_18_stroke_index') }}"></td>
                                ...
                                <td><input id="hole_18_ladies_stroke_index" type="text" class="form-control{{ $errors->has('hole_18_ladies_stroke_index') ? ' is-invalid' : '' }}" name="hole_18_ladies_stroke_index" value="{{ old('hole_18_ladies_stroke_index') }}"></td>
                            </tr>                                                                                                     
