...
<table>
    ...
    <tr>
        ...
        <td><input id="hole_1_fir" type="checkbox" class="form-control" name="hole_1_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_1_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_1_par < 4 ? "disabled":"") }}@endif ></td>
    ...
    <tr>
        ...
        <td><input id="hole_2_fir" type="checkbox" class="form-control" name="hole_2_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_2_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_2_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_3_fir" type="checkbox" class="form-control" name="hole_3_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_3_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_3_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_4_fir" type="checkbox" class="form-control" name="hole_4_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_4_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_4_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_5_fir" type="checkbox" class="form-control" name="hole_5_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_5_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_5_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_6_fir" type="checkbox" class="form-control" name="hole_6_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_6_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_6_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_7_fir" type="checkbox" class="form-control" name="hole_7_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_7_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_7_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_8_fir" type="checkbox" class="form-control" name="hole_8_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_8_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_8_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_9_fir" type="checkbox" class="form-control" name="hole_9_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_9_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_9_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_10_fir" type="checkbox" class="form-control" name="hole_10_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_10_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_10_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_11_fir" type="checkbox" class="form-control" name="hole_11_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_11_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_11_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_12_fir" type="checkbox" class="form-control" name="hole_12_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_12_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_12_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_13_fir" type="checkbox" class="form-control" name="hole_13_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_13_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_13_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_14_fir" type="checkbox" class="form-control" name="hole_14_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_14_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_14_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_15_fir" type="checkbox" class="form-control" name="hole_15_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_15_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_15_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_16_fir" type="checkbox" class="form-control" name="hole_16_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_16_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_16_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_17_fir" type="checkbox" class="form-control" name="hole_17_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_17_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_17_par < 4 ? "disabled":"") }}@endif></td>
    ...
    <tr>
        ...
        <td><input id="hole_18_fir" type="checkbox" class="form-control" name="hole_18_fir" value="1" @if ($selected_yards === 'red'){{ ($par->hole_18_ladies_par < 4 ? "disabled":"") }} @else{{ ($par->hole_18_par < 4 ? "disabled":"") }}@endif></td>
