...
Route::get('ajax_getcourseyards', 'GetCourseController@GetCourseId')->name('getcourseyards');
Route::get('ajax_getcoursestats', 'GetCourseController@GetCourseId')->name('getcoursestats');
