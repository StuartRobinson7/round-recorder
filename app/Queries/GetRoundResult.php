...
class GetRoundResult {
    ...
    public function roundResult($id){        
        ...
        if($round_result->yards === 'white'){
            ...
            $first_nine_par = intval($round_result->hole_1_white) + intval($round_result->hole_2_white) + intval($round_result->hole_3_white) + intval($round_result->hole_4_white) + intval($round_result->hole_5_white) + intval($round_result->hole_6_white) + intval($round_result->hole_7_white) + intval($round_result->hole_8_white) + intval($round_result->hole_9_white);
            $second_nine_par = intval($round_result->hole_10_white) + intval($round_result->hole_11_white) + intval($round_result->hole_12_white) + intval($round_result->hole_13_white) + intval($round_result->hole_14_white) + intval($round_result->hole_15_white) + intval($round_result->hole_16_white) + intval($round_result->hole_17_white) + intval($round_result->hole_18_white);
            $third_nine_par = intval($round_result->hole_19_white) + intval($round_result->hole_20_white) + intval($round_result->hole_21_white) + intval($round_result->hole_22_white) + intval($round_result->hole_23_white) + intval($round_result->hole_24_white) + intval($round_result->hole_25_white) + intval($round_result->hole_26_white) + intval($round_result->hole_27_white);

        }

        if($round_result->yards === 'yellow'){

            $first_nine_par = intval($round_result->hole_1_yellow) + intval($round_result->hole_2_yellow) + intval($round_result->hole_3_yellow) + intval($round_result->hole_4_yellow) + intval($round_result->hole_5_yellow) + intval($round_result->hole_6_yellow) + intval($round_result->hole_7_yellow) + intval($round_result->hole_8_yellow) + intval($round_result->hole_9_yellow);
            $second_nine_par = intval($round_result->hole_10_yellow) + intval($round_result->hole_11_yellow) + intval($round_result->hole_12_yellow) + intval($round_result->hole_13_yellow) + intval($round_result->hole_14_yellow) + intval($round_result->hole_15_yellow) + intval($round_result->hole_16_yellow) + intval($round_result->hole_17_yellow) + intval($round_result->hole_18_yellow);
            $third_nine_par = intval($round_result->hole_19_yellow) + intval($round_result->hole_20_yellow) + intval($round_result->hole_21_yellow) + intval($round_result->hole_22_yellow) + intval($round_result->hole_23_yellow) + intval($round_result->hole_24_yellow) + intval($round_result->hole_25_yellow) + intval($round_result->hole_26_yellow) + intval($round_result->hole_27_yellow);

        }    
        
        if($round_result->yards === 'red'){

            $first_nine_par = intval($round_result->hole_1_red) + intval($round_result->hole_2_red) + intval($round_result->hole_3_red) + intval($round_result->hole_4_red) + intval($round_result->hole_5_red) + intval($round_result->hole_6_red) + intval($round_result->hole_7_red) + intval($round_result->hole_8_red) + intval($round_result->hole_9_red);
            $second_nine_par = intval($round_result->hole_10_red) + intval($round_result->hole_11_red) + intval($round_result->hole_12_red) + intval($round_result->hole_13_red) + intval($round_result->hole_14_red) + intval($round_result->hole_15_red) + intval($round_result->hole_16_red) + intval($round_result->hole_17_red) + intval($round_result->hole_18_red);
            $third_nine_par = intval($round_result->hole_19_red) + intval($round_result->hole_20_red) + intval($round_result->hole_21_red) + intval($round_result->hole_22_red) + intval($round_result->hole_23_red) + intval($round_result->hole_24_red) + intval($round_result->hole_25_red) + intval($round_result->hole_26_red) + intval($round_result->hole_27_red);
        ...
        $round_result->first_nine_score = intval($round_result->hole_1_score) + intval($course->hole_2_score) + intval($course->hole_3_score) + intval($course->hole_4_score) + intval($course->hole_5_score) + intval($course->hole_6_score) + intval($course->hole_7_score) + intval($course->hole_8_score) + intval($course->hole_9_score);       
        
        $round_result->second_nine_score = intval($round_result->hole_10_score) + intval($course->hole_11_score) + intval($course->hole_12_score) + intval($course->hole_13_score) + intval($course->hole_14_score) + intval($course->hole_15_score) + intval($course->hole_16_score) + intval($course->hole_17_score) + intval($course->hole_18_score);       
        
        $round_result->third_nine_score = intval($round_result->hole_19_score) + intval($course->hole_20_score) + intval($course->hole_21_score) + intval($course->hole_22_score) + intval($course->hole_23_score) + intval($course->hole_24_score) + intval($course->hole_25_score) + intval($course->hole_26_score) + intval($course->hole_27_score);       
        ...
        $round_result->total_spar = $total_par;
        ...
        $round_result->plus_minus = $total_par - $total_score;
        ...
        if($round_result->nine === 'first-nine'){
            ...
            $scrambling = \App\Round::where('rounds.id', $id)
            ->groupBy('rounds.id')
            ->join('courses', 'courses.id', '=', 'course_id')
            ->selectRaw("SUM(
            ...
            $gir_percentage = $firs->gir_percentage;              
