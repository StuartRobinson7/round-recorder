...
class CourseController extends Controller
{
    ...
    public function courseInfo($id){
        ...
        $course_info = $course->merge(
            $first_nine_white->toArray(), $first_nine_white_par->toArray(), $first_nine_yellow->toArray(), $first_nine_yellow_par->toArray(), $first_nine_red->toArray(), $first_nine_red_par->toArray(),
    ...
    public function show($id)
    {
        ...
        */
        ...
        //$this->$course = $course->getCourseInfo();
